...
export default function ExamGenerator({ params }) {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/api/exam-generator`, {
                method: "POST",
                headers: {
            ...
            if (user && username) {
                ...
                if (docId) {
                    toast.success('Updated Exam Generated to History!');
                } else {
                    toast.success('Saved Exam Generated to History!');
                }
                ...
                <div className="bg-white shadow rounded-lg overflow-hidden w-full max-w-lg p-6">
                    <div className="flex flex-col space-y-6">
                        <div className="flex items-center justify-between">
                            <h1 className="text-xl font-bold">Exam Generation</h1>
                        ...
                        <p className="text-gray-600">
                            Generate Exam papers aligned to a topic or text.
                        </p>
                ...
                <div className="bg-white shadow rounded-lg overflow-hidden w-full max-w-lg p-6 animate-blurIn">
                    {isLoading ? (
                        ...
                        <div>
                            ...
                            <DistributeButton docId={docId} formData={formData} result={result} />
                        </div>
                    )}
                </div>
            )}
